...
<template>
  <main class="mx-auto w-full max-w-6xl p-6 md:p-10">
    <header class="mb-8">
      <h1 class="text-3xl font-semibold tracking-tight">MeinDeutsch API Trigger</h1>
      <p class="mt-2 text-slate-400">Frontend reads endpoint field specs directly from backend contracts.</p>
    </header>
